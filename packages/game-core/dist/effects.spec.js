...
describe('DAMAGE_MATCHUP', () => {
    it('VOID attacker deals 1.0x to all armor types', () => {
        const armorTypes = ['FIRE', 'ICE', 'NATURE', 'LIGHT', 'DARK', 'MACHINE', 'VOID', 'RESISTANT'];
...
//# sourceMappingURL=effects.spec.js.map